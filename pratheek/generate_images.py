...
#this is added to make it dynamic
# import encode_text as en

from os.path import join


def gen_main(data_set, t_dim, z_dim, gf_dim, df_dim, image_size, learning_rate,  beta1, n_classes, caption_vector_length, batch_size , checkpoints_dir, images_per_caption,data_dir,text, datasets_root_dir):
